...
Future<User> _getUser(id) async {
  ...
  user = User(
    ...
    emailContactEnabled: doc.data['emailContactEnabled'] ?? false,
    phoneContactEnabled: doc.data['phoneContactEnabled'] ?? false,
...
Future<void> saveUser(User user) async {
  ...
  await docRef.setData({
    ...
    'emailContactEnabled': user.emailContactEnabled,
    'phoneContactEnabled': user.phoneContactEnabled,
